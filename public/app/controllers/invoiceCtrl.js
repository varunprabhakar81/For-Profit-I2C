angular.module('invoiceController', ['customerController', 'chapterController', 'glaccountController', 'itemController','configServices', 'journalentryServices'])

.controller('invoiceCtrl', function(Customer, Chapter, GLAccount, Item, Invoice, InvoiceLine, $timeout, $location, 
    ...
    if($routeParams.id == null) {
        ...
        app.defaultCustomerInfo = function(customer) {
            $scope.invoiceData.billingemail = customer.email;
            $scope.invoiceData.aracct = customer.aracct;
            
            if(customer.invoiceterms) {
                $scope.invoiceData.invoiceterms = customer.invoiceterms;
        ...
        if (data.data.success) {
            ...
            $scope.invoiceData.customer = data.data.invoice.customer;
...
.controller('invoicereportCtrl', function(Customer, Chapter, GLAccount, Item, Invoice, InvoiceLine, $timeout, $location,$scope, Config) {
